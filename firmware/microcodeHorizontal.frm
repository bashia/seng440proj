...
08 | mul r7, r3, #4904878        | NOP                             @ Calculate G components 
09 | mul r8, r3, #4904867        | NOP
09 | add r4, r4, r7              | add r5, r5, r8
0A | mul r7, r3, #4904877        | NOP
0B | add r6, r6, r7              | mov r3, r0 asl #24              @ Unpack B
0C | mov r3, r3 asr #24          | NOP
0D | mul r7, r3, #952566         | NOP                             @ Calculate G components
0E | mul r8, r3, #7403274        | NOP
0E | add r4, r4, r7		           | add r5, r5, r8
10 | mul r7, r3, #952567         | NOP               		                         
